    ...
    <section className="py-8 px-3 bg-black text-black">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="w-full">
          <div className="w-full bg-[#FAFAF9] mx-auto backdrop-blur-md p-6 rounded-2xl shadow-lg">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
              ...
              <select className="w-full lg:w-auto rounded-full px-5 py-3 border border-gray-300 text-black focus:outline-none">
              ...
              <button className="w-full lg:w-auto bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-full">
                Rechercher
              </button>
            </div>
          </div>
        ...
        <div className="text-center mt-8">
          <button className="w-full sm:w-auto bg-black hover:bg-gray-800 text-white font-semibold px-8 py-4 rounded-lg transition shadow-md hover:shadow-[0_8px_32px_rgba(210,180,140,0.3)] flex items-center gap-3 mx-auto border border-white">
